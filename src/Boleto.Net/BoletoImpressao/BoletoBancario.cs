...
namespace BoletoNet
{
    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        public string MontaHtml(string fileName, string logoCedente)
        {
            ...
            string fnLogo = Path.Combine(Path.GetTempPath(), @"BoletoNet" + Utils.FormatCode(_ibanco.Codigo.ToString(), 3) + ".jpg");
            ...
            string fnBarra = Path.Combine(Path.GetTempPath(), @"BoletoNetBarra.gif");
            ...
            string fnCodigoBarras = fileName + @"CodigoBarras.gif";
            C2of5i cb = new C2of5i(Boleto.CodigoBarra.Codigo, 1, 50, Boleto.CodigoBarra.Codigo.Length);
